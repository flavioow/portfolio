...
const links = {
    ...
    planning:
        "https://vinniciusgomes.dev/articles/biome-js-um-novo-lint-e-formatter-para-javascript-e-typescript",
                            ...
                            <div
                                ...
                                <div className="grid gap-4">
                                    ...
                                    {skill.stat && (
                                        <Link
                                            href={skill.link}
                                            className="inline-flex items-baseline gap-2 px-4 py-2 rounded-lg bg-accent/10 border border-border">
