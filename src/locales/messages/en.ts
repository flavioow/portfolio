export default {
  home: {
    ...
    projects: {
      ...
      neomental: {
        description: "Neo Mental is a space designed to promote well-being and emotional care in an accessible way. Through the platform, employees can chat with a virtual psychologist and receive personalized reports, companies can offer mental health benefits to their teams, and psychologists have the chance to impact more lives with their work."
      }
    }
  },
  navbar: {
